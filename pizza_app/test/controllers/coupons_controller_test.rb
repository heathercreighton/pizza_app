...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { deal: @coupon.deal, description: @coupon.description, exclusions: @coupon.exclusions, from_date: @coupon.from_date, to_date: @coupon.to_date }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { deal: @coupon.deal, description: @coupon.description, exclusions: @coupon.exclusions, from_date: @coupon.from_date, to_date: @coupon.to_date }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
